...
public class EditHoKhauJFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EditHoKhauJFrame
     */
     ...
     * @param parentJFrame
     */
    public EditHoKhauJFrame(JFrame parentJFrame, int idTemp) {
        initComponents();
    ...
    private void setPrevData() {
        this.hoKhauBean = service.getHoKhauById(this.idTemp);
        NhanKhauModel tempChuHo = this.hoKhauBean.getChuHo();
        this.list = service.getListMemOfFamily(idTemp);
        maHoKhauJtf.setText(this.hoKhauBean.getHoKhauModel().getMaHoKhau());
        maKhuVucJtf.setText(this.hoKhauBean.getHoKhauModel().getMaKhuVuc());
        diaChiJtf.setText(this.hoKhauBean.getHoKhauModel().getDiaChi());
        this.chuHo.getNhanKhauModel().setID(tempChuHo.getID());
        this.chuHo.getNhanKhauModel().setHoTen(tempChuHo.getHoTen());
        this.chuHo.getNhanKhauModel().setNamSinh(tempChuHo.getNamSinh());
//        this.chuHo.getChungMinhThuModel().setSoCMT(this.hoKhauBean.);
        for(int i = 0; i < this.list.size(); i++) {
            if(this.list.get(i).getThanhVienCuaHoModel().getQuanHeVoiChuHo().equals("Chủ hộ")) {
                this.chuHo.getChungMinhThuModel().setSoCMT(this.list.get(i).getNhanKhau().getChungMinhThuModel().getSoCMT());
            }
        }
    }
    ...
    private void selectBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_selectBtnActionPerformed
        ChoosePeople choosePeople = new ChoosePeople(this.chuHo, this, "edit");
    ...
    private void editBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editBtnActionPerformed
        ChangeListPeopleJframe changeListPeopleJframe = new ChangeListPeopleJframe(list, this, "edit");
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        if (this.maHoKhauJtf.getText().trim().isEmpty()
            ...
            try {
                this.controller.editHoKhau(hoKhauBean);
                this.parentJFrame.setEnabled(true);
                dispose();
            } catch (Exception e) {
